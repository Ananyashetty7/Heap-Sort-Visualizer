...
def set_app_style():
    ...
    st.markdown(
        ...
        <style>
            .stApp {{
                background-image: linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url("data:image/png;base64,{base64_image_bg}");
            ...
            .stSidebar {{
                ...
                position: relative;
                padding-left: 120px; /* Adjust padding to avoid overlap with the image */
            }}
